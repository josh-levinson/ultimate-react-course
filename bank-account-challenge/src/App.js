...
6. When the customer pays the loan, the opposite happens: the money is taken from the balance, and the 'loan' will get 
back to 0. This can lead to negative balances, but that's no problem, because the customer can't close their account now (see 
  next point)
    ...
    <div className="App">
      ...
      <p>
        <button
          ...
          disabled={!isActive || loan === 0 || balance < LOAN_AMOUNT}
        >
          Pay loan
        </button>
      </p>
